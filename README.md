...
网页文字武侠人生模拟（原「武侠人生模拟器」）：出身入世 → 按岁推演 → 抉择改命运 → 结算短传与分享图。当前交付至 **Phase 20**（`design/迭代计划-v14.md`：终局连贯 · 死前铺垫 · 告别后再结算）。
...
- `design/迭代计划-v14.md` — **第十四版 / Phase 20**（终局连贯 · 死前铺垫 · 告别后再结算）✅
- `design/迭代计划-v13.md` — Phase 19 已交付（角色选项一图一选项 · 实时文生图成本调研）
